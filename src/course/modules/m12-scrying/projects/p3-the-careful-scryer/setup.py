...
SHOP_HTML = """<html><body><ul class="wares">
  <li class="item"><span class="name">Rope</span><span class="price">£4.50</span></li>
  <li class="item"><span class="name">Lantern</span><span class="price">£12.00</span></li>
  <li class="item"><span class="name">Coin pouch</span><span class="price">£2.25</span></li>
</ul></body></html>"""

BROKEN_SHOP_HTML = """<html><body><ul class="wares">
  <li class="item"><span class="name">Rope</span><span class="price">£4.50</span></li>
  <li class="item"><span class="name">Mystery</span></li>
  <li class="item"><span class="name">Ash</span><span class="price">ask within</span></li>
</ul></body></html>"""

EMPTY_SHOP_HTML = "<html><body><p>The shop is shut.</p></body></html>"
